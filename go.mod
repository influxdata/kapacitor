...
replace (
	github.com/influxdata/flux => github.com/influxdata/flux v0.197.0
	github.com/prometheus/common => github.com/prometheus/common v0.20.0
	github.com/prometheus/prometheus => github.com/prometheus/prometheus v1.8.2-0.20210331101223-3cafc58827d1
