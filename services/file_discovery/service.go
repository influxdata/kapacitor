...
import (
	...
	pfile "github.com/prometheus/prometheus/discovery/file"
)

// Service is the file discovery service
type Service struct {
	Configs []Config
	mu      sync.Mutex
...
func (s *Service) Test(options interface{}) error {
	...
	// TODO: Need to think about what to do here
	// TODO: Need to think about what to do here
	discoverer := pfile.NewDiscovery(sd, scraper.NewLogger(log.New(os.Stdout, "figure out", log.LstdFlags)))
