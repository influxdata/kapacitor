...
func newInfluxDBOutNode(et *ExecutingTask, n *pipeline.InfluxDBOutNode, l *log.Logger, nt Notary) (*InfluxDBOutNode, error) {
	...
	in := &InfluxDBOutNode{
		node:        node{Node: n, et: et, logger: l, notary: notary.WithPrefix(nt, "node", "influxDBOut")},
		i:           n,
